...
PedigreeExport.exportAsCanrisk = async function(pedigree, idGenerationPreference) {
  const { exportAsCanrisk } = await import('./canriskExport.js');
  return exportAsCanrisk(pedigree, idGenerationPreference);
};
